...
#! q_op(4)[a:1->1,b:2->1,c:3->1,d:4->1,e:2->2,
#!f:3->2,g:4->2,h:3->3,i:4->3,j:4->4]
...
#!
#! Algebroid generated by the right quiver
#! q_op(4)[a:1->1,b:2->1,c:3->1,d:4->1,e:2->2,f:3->2,g:4->2,h:3->\
#! 3,i:4->3,j:4->4]
#!  |
#!  V
#! The category of functors: Algebroid generated by the right
#! quiver q(4)[a:1->1,b:1->2,c:1->3,d:1->4,e:2->2,f:2->3,g:2->4,
#! h:3->3,i:3->4,j:4->4] -> Category of matrices over GF(3)
Y(kqop.1) = YonedaProjective(Hom(kq,GF3),kq.1);
#! true
#! @EndExample