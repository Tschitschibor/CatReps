...
objects := SetOfObjects( ccat );
#! [ An object in subcategory given by: <An object in FinSets>,
#!   An object in subcategory given by: <An object in FinSets>,
#!   An object in subcategory given by: <An object in FinSets>,
#!   An object in subcategory given by: <An object in FinSets> ]
gmorphisms := SetOfGeneratingMorphisms( ccat );
...
#! <(1)->0, (2)->0, (3)->0, (4)->0; (a)->0x0, (b)->0x0, (c)->0x0,
#! (d)->0x0, (e)->0x0, (f)->0x0, (g)->0x0, (h)->0x0, (i)->0x0, (4)->0x0>
const := TensorUnit( CatReps );
#! <(1)->1, (2)->1, (3)->1, (4)->1; (a)->1x1, (b)->1x1, (c)->1x1,
#! (d)->1x1, (e)->1x1, (f)->1x1, (g)->1x1, (h)->1x1, (i)->1x1, (4)->1x1>
UnderlyingQuiverAlgebra( kq );
#! (GF(3) * q) / [ Z(3)^0*(a*a*a*a) + Z(3)*(1), Z(3)^0*(e*e) + Z(3)*(2),
#!Z(3)^0*(h*h) + Z(3)*(3), Z(3)^0*(j) + Z(3)*(4), Z(3)*(b*f) + Z(3)^0*(c),
